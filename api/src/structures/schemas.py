"""Kokoro-FastAPI schemas — forked from v0.2.4 to add markdown_normalization toggle.

Upstream: https://github.com/remsky/Kokoro-FastAPI/blob/v0.2.4/api/src/structures/schemas.py
